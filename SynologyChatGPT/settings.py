"""
Django settings for SynologyChatGPT project.
...
SECRET_KEY = 'django-insecure-l$!kt6kqvian+$t@_!x)snyari%+(#$!66oavkk5u8#i@v@-8g'
...
ROOT_URLCONF = 'SynologyChatGPT.urls'
...
WSGI_APPLICATION = 'SynologyChatGPT.wsgi.application'
